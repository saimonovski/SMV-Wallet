...
public class Config implements io.github.saimonovski.smv.wallet.api.object.Config {
    ...
    public Product getProduct(String productId, int productSlot) {
        ...
        return
        io.github.saimonovski.smv.wallet.system.gems.core.entity.Product.Builder.builder()
                ...
                .setProvider(this.wallet.getGemProvider())
    ...
    public Category getCategory(String categoryId) {
        ...
        return io.github.saimonovski.smv.wallet.system.gems.core.entity.Category.Builder
                .builder()
                .setId(categoryId)
    ...
    public DailyButton dailyButton() {
        return new DailyButton() {
            ...
            public Database database() {
                return wallet.getGemDatabase();
            }

            @Override
            public EconomyProvider provider() {
                return wallet.getGemProvider();
            }
